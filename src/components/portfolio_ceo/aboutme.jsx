...
const AboutMeSlide = () => {
  ...
  return (
    <div className="w-[100vw] h-fit min-h-[100vh] bg-white" id="naiduAbout">
      <div className="w-[90%] m-auto flex flex-col items-center justify-center py-20 bg-white">
        <div className="w-full">
          <h2 className="text-3xl md:text-5xl gil-bold text-gray-800 mb-6">
            About Me
          </h2>
          <div className="flex flex-col md:flex-row h-full">
            ...
            />
            <div className="h-fit md:h-[70vh] w-full flex flex-col justify-between items-start p-4 md:p-10">
              ...
              <div className="w-[80%] rounded-xl ml-4">{grid()}</div>
            </div>
          </div>
        </div>
      </div>
