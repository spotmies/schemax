          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:ml-8 flex flex-col justify-center">
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                Hi, my name is [CEO Name] and I am the CEO of [Company Name]. I
                have been with the company for [number of years] and have played
                a critical role in [brief description of major accomplishments].
              </p>
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                My leadership style is focused on [brief description of
                leadership philosophy]. I believe in [brief description of core
